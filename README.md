...
# DeepStruc
Welcome to CIF-Finder or CIFF!

CIFF is a machine learning based classifier, which can be used to suggest Crystallographic Information File (CIF)
based on Pair Distribution Function (PDF) data.
