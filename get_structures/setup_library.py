...
def main(structure_directory: str):
    ...
    """
    cif_directory = (
        os.path.join(structure_directory, "cif")
        if not structure_directory.endswith("cif")
        else structure_directory
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "path", type=str, help="Path to the directory containing CIF files."
    )
